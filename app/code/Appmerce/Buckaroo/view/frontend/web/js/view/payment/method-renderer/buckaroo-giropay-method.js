...
define(
    ...
    function ($, Component, placeOrderAction, selectPaymentMethodAction, customer, checkoutData, additionalValidators, url) {
        ...
        return Component.extend({
            defaults: {
                template: 'Appmerce_Buckaroo/payment/buckaroo-giropay-form',
                buckarooIssuerId: ''
            },
            initObservable: function () {
            	this._super()
                    .observe('bankleitzahl');
                return this;
            },
            getData: function () {
                var additionalData = null;
                if (this.bankleitzahl()) {
                    additionalData = {};
                    additionalData['bankleitzahl'] = this.bankleitzahl();
                }
                return {
            ...
            validate: function () {
                var form = 'form[data-role=buckaroo-giropay-form]';
